...
class MaterialDesignIcons {
  constructor() {
    this.iconsCount = 0;
    this.newIconsCount = 0;
    this.deprecatedIconsCount = 0;
    this.icons = [
      {
      name: 'ab-testing',
      hex: 'F01C9',
      ...
      name: 'forms-textbox-lock',
      hex: 'F135D',
      version: '4.9.95'
    }, {
      name: 'forms-textbox-password',
      hex: 'F07F5',
      version: '2.0.46'
    }, {
  ...
  init(){
    ...
    this.icons.forEach(function (icon) {
      const item = self.getIconItem(icon, self.isNew(icon));
      document.getElementById('icons').appendChild(item);
      if (self.isNew(icon)) {
        const newItem = self.getIconItem(icon, false, false);
