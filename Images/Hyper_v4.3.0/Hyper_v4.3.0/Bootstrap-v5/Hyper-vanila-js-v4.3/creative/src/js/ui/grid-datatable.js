 ...
 */
 ...
 class GridDatatable {
   ...
   basicTableInit(){
     ...
     grid.render(document.getElementById('basic-datatable-wrapper'));
 
     // document.querySelectorAll('.gridjs .gridjs-search').forEach(function(e){
   ...
   selectionInit(){
     ...
     grid.render(document.getElementById('selection-datatable-wrapper'));
