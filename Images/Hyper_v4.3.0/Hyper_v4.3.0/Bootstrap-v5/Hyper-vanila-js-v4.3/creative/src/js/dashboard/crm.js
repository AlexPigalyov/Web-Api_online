...
import Todo from '../components/todo';
 ...
 class CRMDashboard{
   ...
   initCharts(){
     ...
     var dataColors = document.getElementById('campaign-sent-chart')
...
//
     var colors = ["#727cf5", "#0acf97", "#fa5c7c", "#ffbc00"];
     var dataColors = document.getElementById('new-leads-chart')
       .getAttribute('data-colors');
     if (dataColors) {
       colors = dataColors.split(",");
     }
...
//
     var colors = ["#727cf5", "#0acf97", "#fa5c7c", "#ffbc00"];
     var dataColors = document.getElementById('deals-chart')
       .getAttribute('data-colors');
     if (dataColors) {
       colors = dataColors.split(",");
     }
...
//
     var colors = ["#727cf5", "#0acf97", "#fa5c7c", "#ffbc00"];
     var dataColors =document.getElementById('booked-revenue-chart')
       .getAttribute('data-colors');
     if (dataColors) {
       colors = dataColors.split(",");
     }
...
//
     var colors = ["#727cf5", "#0acf97", "#fa5c7c", "#ffbc00"];
     var dataColors = document.getElementById('dash-campaigns-chart')
       .getAttribute('data-colors');
     if (dataColors) {
       colors = dataColors.split(",");
     }
...
//
     ...
     var colors = ["#727cf5", "#0acf97", "#fa5c7c", "#ffbc00"];
     var dataColors = document.getElementById('dash-revenue-chart')
       .getAttribute('data-colors');
     if (dataColors) {
       colors = dataColors.split(",");
     }
